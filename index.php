...
<head>
<!-- 
	Project : Projet Fil Rouge No 2 [YPSOLON]
	Admin: Emir STAALI
	Date: 30/04/2024
	Version: 0.1 
-->
...
<?php
  ...
  ?>
  <p style="text-align:center"><h1> - Application YPSOLAP -</h1><h3>Version 0.1</h3></p>
  <p><a href="index.php">Formulaire des utilisateurs</a> | <a href="index.php?action=affusers">Liste des utilisateurs</a> </p>

  <?php
  switch ($_GET["action"]) {
   	case "envoi" : // Actions a realiser lors de la validation du formulaire
	   	try {
	   		$nom = $_GET["nom"];
	   		$prenom = $_GET["prenom"];
	   		$promo = $_GET["promo"];
			...
			echo "<p>Utilisateur enregistr&eacute; !</p>";
		}
		...
		break;
	case "affusers" : // Affiche le tableau de la liste des utilisateurs
		try {
		...
		break;
	case "delete" : // Action lors de la suppression d'un utilisateur
        try {
            //On récupère les infos de la table
        ...
        break;
	default : // Page par defaut affichant le formulaire
  ...
  ?>
<br />
  <p>Projet Fil Rouge No 2 - Application Web [linux/nginx/mariadb/php] </p>
